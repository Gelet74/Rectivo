...
namespace recTivo.MVVM.Base
{
    public class MVBase : ValidatableViewModel
    {
        ...
        protected async Task<List<T>> GetAllAsync<T>(IRepository<T> repo) where T : class
        {
        ...
        protected async Task<T?> GetByIdAsync<T>(IRepository<T> repo, int id) where T : class
        {
            try
            {
        ...
        protected async Task<bool> AddAsync<T>(IRepository<T> repo, T entity) where T : class
        {
            try
            {
        ...
        protected async Task<bool> UpdateAsync<T>(IRepository<T> repo, T entity) where T : class
        {
            try
            {
        ...
        protected async Task<bool> AddOrUpdateAsync<T>(IRepository<T> repo, T entity) where T : class
        {
            try
            {
